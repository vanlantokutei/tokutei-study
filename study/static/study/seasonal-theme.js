(function(){
  ...
  function focusPlayer(){
    ...
    audio.addEventListener('ended',function(){load(index+1,0);begin()});audio.addEventListener('play',function(){play.textContent='⏸'});audio.addEventListener('pause',function(){play.textContent='▶'});audio.addEventListener('error',function(){now.textContent='Không tải được MP3 · chờ Render deploy xong'});
