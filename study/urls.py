...
urlpatterns = [
    ...
    path('jlpt/n5/vocabulary/lesson-3/', TemplateView.as_view(template_name='study/jlpt_n5_vocabulary_lesson3.html'), name='jlpt_n5_vocabulary_lesson3'),
    path('jlpt/n5/vocabulary/lesson-4/', TemplateView.as_view(template_name='study/jlpt_n5_vocabulary_lesson4.html'), name='jlpt_n5_vocabulary_lesson4'),
    path('jlpt/n5/vocabulary/lesson-5/', TemplateView.as_view(template_name='study/jlpt_n5_vocabulary_lesson5.html'), name='jlpt_n5_vocabulary_lesson5'),
    path('jlpt/n5/vocabulary/lesson-6/', TemplateView.as_view(template_name='study/jlpt_n5_vocabulary_lesson6.html'), name='jlpt_n5_vocabulary_lesson6'),
    path('jlpt/n5/vocabulary/lesson-7/', TemplateView.as_view(template_name='study/jlpt_n5_vocabulary_lesson7.html'), name='jlpt_n5_vocabulary_lesson7'),
    path('jlpt/n5/vocabulary/lesson-8/', TemplateView.as_view(template_name='study/jlpt_n5_vocabulary_lesson8.html'), name='jlpt_n5_vocabulary_lesson8'),
    path('jlpt/n5/vocabulary/lesson-9/', TemplateView.as_view(template_name='study/jlpt_n5_vocabulary_lesson9.html'), name='jlpt_n5_vocabulary_lesson9'),
    ...
    path('jlpt/n5/vocabulary/lesson-14/', TemplateView.as_view(template_name='study/jlpt_n5_vocabulary_lesson14.html'), name='jlpt_n5_vocabulary_lesson14'),
    path('jlpt/n5/vocabulary/lesson-15/', TemplateView.as_view(template_name='study/jlpt_n5_vocabulary_lesson15.html'), name='jlpt_n5_vocabulary_lesson15'),
